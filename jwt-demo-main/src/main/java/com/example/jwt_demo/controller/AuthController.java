...
public class AuthController {
    ...
    public String validateUser(@PathVariable String id) {
        ...
        user.setActive(true);
        emailService.sendAccountValidatedNotification(user.getEmail());
        userRepository.save(user);
    ...
    public ResponseEntity<String> assignRole(
        ...
        if (userOpt.isPresent()) {
            ...
            return ResponseEntity.ok("Rôle " + role + " assigné à l'utilisateur " + user.getUsername());
        }
    ...
    public ResponseEntity<?> deleteUser(@PathVariable String id) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body("Utilisateur avec ID " + id + " introuvable");
    }
